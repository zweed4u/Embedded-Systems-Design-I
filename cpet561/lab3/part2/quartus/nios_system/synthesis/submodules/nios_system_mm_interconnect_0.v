...
module nios_system_mm_interconnect_0 (
		...
		output wire [3:0]  inferred_ram_avalon_slave_0_byteenable,         //                                         .byteenable
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> KEY1_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> KEY1_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // KEY1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> KEY1_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> KEY1_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> KEY1_s1_agent:cp_endofpacket
	...
	wire         key1_s1_agent_rp_valid;                                                             // KEY1_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] key1_s1_agent_rp_data;                                                              // KEY1_s1_agent:rp_data -> router_007:sink_data
	wire         key1_s1_agent_rp_ready;                                                             // router_007:sink_ready -> KEY1_s1_agent:rp_ready
	wire         key1_s1_agent_rp_startofpacket;                                                     // KEY1_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         key1_s1_agent_rp_endofpacket;                                                       // KEY1_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         key1_s1_agent_rdata_fifo_src_valid;                                                 // KEY1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] key1_s1_agent_rdata_fifo_src_data;                                                  // KEY1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         key1_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_005:in_0_ready -> KEY1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> KEY1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> KEY1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // KEY1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> KEY1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.av_byteenable          (inferred_ram_avalon_slave_0_byteenable),             //                         .byteenable
		.av_read                (),                                                   //              (terminated)
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
		.av_burstcount          (),                                                   //              (terminated)
