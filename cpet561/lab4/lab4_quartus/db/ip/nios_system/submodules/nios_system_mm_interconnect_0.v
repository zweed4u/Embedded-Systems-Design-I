...
module nios_system_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> iic_clock_bit_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // iic_clock_bit_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> iic_clock_bit_s1_agent:cp_channel
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> iic_data_bit_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> iic_data_bit_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // iic_data_bit_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> iic_data_bit_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> iic_data_bit_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> iic_data_bit_s1_agent:cp_endofpacket
	...
	wire  [92:0] iic_clock_bit_s1_agent_rp_data;                                                     // iic_clock_bit_s1_agent:rp_data -> router_006:sink_data
	...
	wire         iic_data_bit_s1_agent_rp_valid;                                                     // iic_data_bit_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] iic_data_bit_s1_agent_rp_data;                                                      // iic_data_bit_s1_agent:rp_data -> router_008:sink_data
	wire         iic_data_bit_s1_agent_rp_ready;                                                     // router_008:sink_ready -> iic_data_bit_s1_agent:rp_ready
	wire         iic_data_bit_s1_agent_rp_startofpacket;                                             // iic_data_bit_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         iic_data_bit_s1_agent_rp_endofpacket;                                               // iic_data_bit_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         iic_data_bit_s1_agent_rdata_fifo_src_valid;                                         // iic_data_bit_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] iic_data_bit_s1_agent_rdata_fifo_src_data;                                          // iic_data_bit_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         iic_data_bit_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_006:in_0_ready -> iic_data_bit_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> iic_data_bit_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> iic_data_bit_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // iic_data_bit_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> iic_data_bit_s1_agent:rdata_fifo_sink_error
